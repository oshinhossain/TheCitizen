...
class PasswordInput extends StatelessWidget with Base, ValidationService {
  @override
    ...
    return Obx(
      () => Focus(
        child: TextField(
          ...
          obscureText: authC.isRegNewObscure.value,
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: IconButton(
              ...
              icon: Icon(
                authC.isRegNewObscure.value
                    ? Icons.visibility_off
                    : Icons.visibility,
                color: AppTheme.borderColor,
              ),
              onPressed: () {
                authC.isRegNewObscure.toggle();
              },
            ),
            ...
            errorText: validateResetNewPassword(authC.regPassword.value),
          ),
        ),
      ),
    );
