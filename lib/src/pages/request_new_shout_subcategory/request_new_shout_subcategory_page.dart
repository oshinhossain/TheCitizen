...
import 'package:the_citizen_app/src/pages/request_new_shout_subcategory/my_request_subcategory_page.dart';
import 'package:the_citizen_app/src/pages/request_new_shout_subcategory/send_request_subcategory_page.dart';
import 'package:the_citizen_app/src/widgets/app_bar_title.dart';

class RequestNewShoutSubCategoryPage extends StatefulWidget {
  // final String? title;

  // RequestNewShoutCategoryPage({this.title});

  @override
  _RequestNewShoutSubCategoryPageState createState() => new _RequestNewShoutSubCategoryPageState();
}

class _RequestNewShoutSubCategoryPageState extends State<RequestNewShoutSubCategoryPage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        elevation: 0,
        title: appBarTitle(title: 'Request New Shout SubCategory'),
      ...
      body: TabBarView(
        ...
        children: [
          SendRequestSubCategoryPage(),
          MyRequestSubCategoryPage(),
        ],
      ),
    );
  }
