...
class SscCertificatePage extends StatelessWidget with Base {
  @override
                ...
                Container(
                  ...
                  child: Column(
                    children: <Widget>[
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: Align(
                              alignment: Alignment.centerLeft,
                              child: KText(
                                text: authC.userDetail.value!.sscGroup ?? 'N/A',
                                bold: true,
                              ),
                            ),
                          ),
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: Align(
                              alignment: Alignment.centerLeft,
                              child: KText(
                                text: authC.userDetail.value!.schoolName != null
                                    ? authC.userDetail.value!.schoolName
                                        .toString()
                                    : 'N/A',
                                bold: true,
                              ),
                        ...
                        children: [
                          ...
                          Expanded(
                            ...
                            child: Align(
                              ...
                              child: KText(
                                text:
                                    authC.userDetail.value!.sscPassYear != null
                                        ? authC.userDetail.value!.sscPassYear
                                            .toString()
                                        : 'N/A',
                                bold: true,
                              ),
                      ...
                      //         child: KText(
                      //           text:
                      //               authC.userDetail.value!.sscCompleted != null
                      //                   ? authC.userDetail.value!.sscCompleted
                      //                       .toString()
                      //                   : 'N/A',
                      //           bold: true,
                      //         ),
                          ...
                          updateProfileCreateC.sscImg.value != null &&
                              ...
                              ? Container(
                                  ...
                                  child: GestureDetector(
                                    onTap: updateProfileCreateC.sscImg.value !=
                                                null &&
                                            updateProfileCreateC.ssc.value ==
                                                null
                                        ? () async {
                                            await showDialog(
                                              context: context,
